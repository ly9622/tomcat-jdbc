...
public class TestSlowQueryReport extends DefaultTestCase {
    public static final String superSlowSql = "select count(1) from test where val1 like 'ewq%eq' and val2 = 'ew%rre' and val3 = 'sda%da' and val4 = 'dad%ada' and name=?";
    ...
    public void testSlowSql() throws Exception {
        ...
        for (int i=0; i<count; i++) {
        	PreparedStatement ps = con.prepareStatement(superSlowSql);
        	ps.setString(1, "test");
